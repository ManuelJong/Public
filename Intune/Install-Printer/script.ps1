...
.DESCRIPTION
    ...
    - Automatic .intunewin package creation (always recreated)
...
.EXAMPLE
    ...
    This will automatically create the .intunewin package (always recreated), create a Win32 app in Intune, and optionally use DriverWizard.exe and PrnInst.exe for advanced driver installation scenarios.
...
# Always create (overwrite) the package
